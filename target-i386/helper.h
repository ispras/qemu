...
DEF_HELPER_2(set_inhibit_irq, void, env, i32)
...
DEF_HELPER_2(vmptrld, void, env, i64)
DEF_HELPER_2(vmptrst, void, env, i64)
DEF_HELPER_2(vmclear, void, env, i64)
DEF_HELPER_2(vmread, i64, env, i64)
DEF_HELPER_3(vmwrite, void, env, i64, i64)
DEF_HELPER_2(vmlaunch_vmresume, void, env, tl)
DEF_HELPER_1(vmxoff, void, env)
DEF_HELPER_2(vmxon, void, env, i64)
DEF_HELPER_1(vm_succeed, void, env)
DEF_HELPER_2(vmx_set_exit_reason, void, env, i32)
DEF_HELPER_2(vmx_set_param, void, int, i64)
DEF_HELPER_2(vmx_need_exit, void, env, i32)
DEF_HELPER_1(vmx_check_int_window_exiting, void, env)
